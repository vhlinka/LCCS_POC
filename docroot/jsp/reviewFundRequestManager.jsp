...
<portlet:actionURL var="approveRequestManagerURL" name="approveFundRequestManager"></portlet:actionURL>
<portlet:actionURL var="declineRequestManagerURL" name="declineFundRequestManager"></portlet:actionURL>

<%RowChecker rowCh = new RowChecker(renderResponse); %>
<liferay-ui:panel-container id="bootstrap31">
	<aui:form name="SacwisForm" method="post" action="${approveRequestManagerURL}">
		...
		<aui:button-row>
			<aui:button type="cancel" value="Decline" onClick="${declineRequestManagerURL}" />
